...
import { getContactPageInfo } from "@/modules/contact-us/actions/contact.action";
...
export default async function ContactPage() {
    const { embedMapUrl, headquarters, email, phoneNumber } =
        await getContactPageInfo();

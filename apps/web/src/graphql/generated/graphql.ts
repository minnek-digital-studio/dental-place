...
/** Connection between the ServiceSettings_Fields type and the MediaItem type */
...
export type MenuItemObjectUnion = CallToAction | CaseStudy | Category | Page | Post | Service | Tag | Team;

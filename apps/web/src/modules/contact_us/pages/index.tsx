    ...
    return (
        <>
            <div
                ...
                <h1 className="text-white font-bold text-5xl md:text-6xl text-center mt-16 md:mt-20">Contáctanos</h1>
            </div>

            <div className="absolute w-full -translate-y-36 md:-translate-y-28">
